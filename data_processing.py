...
def finalize_data_lestari():
    ...
    df_lestari = df_lestari[
        ~df_lestari['title'].isin([
            ...
            'JUALAN TANPA JUALAN DENGAN MENARIK PELANGGAN MELALUI STORYTELLING',
            'SUSTAINABILITY ASSESSMENT AND SOCIAL ACCEPTANCE OF HALAL PRODUCTS',
            'SUSTAINABILITY HUMAN RESOURCES MANAGEMENT: STRATEGY, CHALLENGES, AND BEST PRACTICES'
        ])
    ]
    df_lestari = (
